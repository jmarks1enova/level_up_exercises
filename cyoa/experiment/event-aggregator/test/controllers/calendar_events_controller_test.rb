...
class CalendarEventsControllerTest < ActionController::TestCase
  ...
  test "should create calendar_event" do
    assert_difference('CalendarEvent.count') do
      post :create, calendar_event: { datetime: @calendar_event.datetime, description: @calendar_event.description, end_time: @calendar_event.end_time, id: @calendar_event.id, start_time: @calendar_event.start_time, title: @calendar_event.title }
    end
  ...
  test "should update calendar_event" do
    patch :update, id: @calendar_event, calendar_event: { datetime: @calendar_event.datetime, description: @calendar_event.description, end_time: @calendar_event.end_time, id: @calendar_event.id, start_time: @calendar_event.start_time, title: @calendar_event.title }
    assert_redirected_to calendar_event_path(assigns(:calendar_event))
  end
